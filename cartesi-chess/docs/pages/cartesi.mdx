...
4. **Invoice:** This is used to give an approval for a state change on the L1 as a result of the computation of the Cartesi Machine
...
2. Issue invoices reedemable as NFts for players getting to a new Elo Milestone

3. Issue invoices reedemable as NFTs on the L1 for the winners of tournaments 
